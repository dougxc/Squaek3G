...
public abstract class EventRequestModifier {
     ...
     */
    public abstract boolean matches(Matcher matcher, EventNotifier notifier);
    ...
    public static final class Count extends EventRequestModifier {
         ...
         * {@inheritDoc}
         */
        public boolean matches(Matcher matcher, EventNotifier notifier) {
            return --count == 0;
        }
    ...
    public final static class ClassOnly extends EventRequestModifier {
         ...
         */
        public boolean matches(Matcher matcher, EventNotifier notifier) {
            return matcher.matches(this, notifier);
        }
    ...
    public static class ThreadOnly extends EventRequestModifier {
         ...
         */
        public boolean matches(Matcher matcher, EventNotifier notifier) {
            return notifier.getThreadID().equals(threadID);
        }
