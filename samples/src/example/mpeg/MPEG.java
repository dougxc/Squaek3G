...
//System.out.println("stop ");
    ...
    private void hibernate() throws IOException {
        ...
        System.out.println("Hibernating " + thisIsolate/* + " after " + VM.branchCount() + " branches"*/);
        thisIsolate.hibernate();
        System.out.println("Reawoke " + thisIsolate/* + " after " + VM.branchCount() + " branches"*/);
    }
...
System.out.println("time = "+(System.currentTimeMillis() - time));
    ...
    public static void main(String args[]) {
        ...
        MPEG app = new MPEG(args.length == 0 ? "random.mpg" : args[0]);
        app.init();
        app.start();
    ...
    InputStream getInputStream() {
        InputStream img = getInputStream0(mpegSourceUrl);
        if (img == null) {
    ...
    private InputStream getInputStream0(String name) {
        if (inputData == null) {
            try {
                //InputStream in = new FileInputStream("random.mpg");
                InputStream in = MPEG.class.getResourceAsStream(name);
                if (in == null) {
