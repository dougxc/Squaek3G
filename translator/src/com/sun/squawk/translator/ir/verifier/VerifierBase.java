 ...
 * in local variables.
 *
 * @author  Nik Shaylor, Edward Carter
 */
public abstract class VerifierBase {
    ...
    public void verify(MethodBody body) {
        ...
        this.body     = body;
        this.trace    = Klass.TRACING_ENABLED && Tracer.isTracing("squawkverifier", method.toString());
        code          = body.getCode();
        ip            = 0;
...
/*end[FLOATS]*/
    ...
    private Klass getType(Klass k, int offset, boolean isStatic) {
