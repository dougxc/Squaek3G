...
public final class Code {
    ...
    private void convertPhase1(Translator translator, Method method, int index) {
        try {
             ...
             * Write trace message.
             */
            if (Klass.TRACING_ENABLED && Tracer.isTracing("converting", method.toString())) {
...
/*if[TRACING_ENABLED]*/
             ...
             * Write trace message.
             */
            if (Klass.TRACING_ENABLED && Tracer.isTracing("ir0", method.toString())) {
                Tracer.traceln("");
...
/*if[TRACING_ENABLED]*/
             ...
             */
            if (Klass.TRACING_ENABLED && Tracer.isTracing("ir1", method.toString())) {
                Tracer.traceln("");
...
/*if[TRACING_ENABLED]*/
             ...
             * bytecode offsets.
             */
            if (Klass.TRACING_ENABLED && Tracer.isTracing("ir2", method.toString())) {
                Tracer.traceln("");
             ...
             */
            if (Klass.TRACING_ENABLED && Tracer.isTracing("methods", method.toString())) {
                Tracer.traceln("");
