/*
 * @(#)HttpConnection.java	1.38 01/08/21
...
public interface HttpConnection extends ContentConnection {
    ...
    /**
     * 301:  The requested resource has been assigned a new permanent
    ...
    /**
     * 401: The request requires user authentication. The response
     *   MUST include a WWW-Authenticate header field  containing 
    ...
    /**
     * 414: The server is refusing to service the request because 
    ...
    /**
     * 505: The server does not support, or refuses to support,
     ...
     *          <code>HttpConnection</code> was last modified,
     *           or 0 if not known.
     * @exception IOException if an error occurred connecting to the server.
     */
