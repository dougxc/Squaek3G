...
public class GraphicsImpl extends Graphics {
    ...
    private static int lastFontID  = -1;
    ...
    void checkContext() {
        ...
        if (current != this) {
            ...
            if (lastFontID != fontMetrics.getFontID()) {
                lastFontID = fontMetrics.getFontID();
                setFont0(lastFontID);
            }
...
//prtn("***setClip "+x+":"+y+":"+w+":"+h);
    ...
    public void setFont(Font font) {
        ...
        setFont0(fontMetrics.getFontID());
    }
    ...
    private void setFont0(int fontID) {
        VM.execGraphicsIO(ChannelConstants.SETFONT, fontID, 0, 0, 0, 0, 0, null, null);
    }
