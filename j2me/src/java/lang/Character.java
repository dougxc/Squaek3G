...
public final class Character {
   ...
   /**
     ...
     */
    private static DefaultCaseConverter caseConverter() {
        if (cc != null) {
           return cc;
        }
        String name = System.getProperty("java.lang.Character.caseConverter");
        if (name == null) {
            cc = new DefaultCaseConverter();
        } else {
            try {
                Class cls = Class.forName(name);
                cc = (DefaultCaseConverter)cls.newInstance();
            } catch(Exception x) {
                throw new RuntimeException("Cannot find case converter class "+name+" -> "+x.getMessage());
            }
        }
        return cc;
    }
    ...
    /**
     * Cached copy of the case converter
     */
    private static DefaultCaseConverter cc;
}
