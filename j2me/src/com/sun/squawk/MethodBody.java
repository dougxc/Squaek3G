...
/*end[TYPEMAP]*/
    ...
    public MethodBody(
        ...
        this.metadata        = (lvt != null || lnt != null) ? new MethodMetadata(definingMethod.getID(), lvt, lnt) : null;
        this.code = code;
/*if[TYPEMAP]*/
...
/*end[TYPEMAP]*/
     ...
     *  header {
     *      {
     *           u4 type;                               // class id of a float, long, double, Address, Offset or UWord local variable
...
/*end[TYPEMAP]*/
    ...
    private static int minfoValue(Object oop, int offset) {
        ...
        int b = NativeUnsafe.getByte(oop, p--) & 0xFF;
        int val = -1;
