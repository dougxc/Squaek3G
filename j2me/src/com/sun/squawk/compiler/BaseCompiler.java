 ...
 *
 * $Id: BaseCompiler.java,v 1.7 2006/04/21 16:33:20 dw29446 Exp $
 */
...
public interface BaseCompiler extends Types {
    ...
    /**
     * Test the top two elements. Push -1 if VALUE1 < VALUE2, push 0 if they are equal, and push 1 if VALUE1 > VALUE2.
     * If either VALUE1 or VALUE2 is a NAN, then push -1
     * Both values must be floats or doubles.
     *
     * <p>
     * Stack: ..., VALUE1, VALUE2 -> ..., RESULT
     * <p>
