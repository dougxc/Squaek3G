 ...
 * </pre></blockquote><hr>
 *
 * @author  Doug Simon, Nik Shaylor, Andrew Crouch
 */
...
/*end[FINALIZATION]*/
        ...
        if (copyingObjectGraph) {
            copyTimings.mark += duration;
        } else {
            collectionTimings.mark += duration;
        }
    }
...
/*end[FINALIZATION]*/
    ...
    private void processWeakReferences() {
        ...
        while (ref != null) {
            ...
            // Ref object should be reomved from the global list of Ref objects
            if (!keep) {
