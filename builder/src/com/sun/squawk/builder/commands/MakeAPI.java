...
class SourceFile {
    ...
    void dump(File baseDir, Collection refs) {
        ...
        try {
            ...
            pw.println("/*");
            pw.println(" * Copyright 2004 Sun Microsystems, Inc. All Rights Reserved.");
            pw.println(" *");
            pw.println(" * This software is the proprietary information of Sun Microsystems, Inc.");
            pw.println(" * Use is subject to license terms.");
            pw.println(" *");
            pw.println(" * This is a part of the Squawk JVM.");
            pw.println(" */");
...
//System.err.println("sourceNameDesc: " + sourceNameDesc);
    ...
    static Suite parse(Reader reader, String source) {
        ...
        String label = parseWord(st, source, ".suite");
