...
public class TestC22 implements Types {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Branch tests failed = " + res);
        System.exit(res);
    }
